...
if (empty($_POST["email"])) {
    $errorMSG = "Missing non-optional field!";
} else {
    $email = $_POST["email"];
}
...
$EmailTo = "info@aatbs.co.za";
$Subject = "AAT: New Request"; 
															...
															<table border="0" cellpadding="30" cellspacing="0" width="100%">
																<tr>
																	<td align="center" valign="top" class="textContent">
																		<h1 style="color:#FFFFFF;line-height:100%;font-family:Helvetica,Arial,sans-serif;font-size:35px;font-weight:normal;margin-bottom:5px;text-align:center;">Hi,</h1>
																		<h2 style="text-align:center;font-weight:normal;font-family:Helvetica,Arial,sans-serif;font-size:23px;margin-bottom:10px;color:#205478;line-height:135%;">You got a request from a client!</h2>
																		<div style="text-align:center;font-family:Helvetica,Arial,sans-serif;font-size:15px;margin-bottom:0;color:#FFFFFF;line-height:135%;">Below are the details related to the request.</div>
																	</td>
																</tr>
															</table>
															<!-- // CONTENT TABLE -->
																		...
																		<table border="0" cellpadding="0" cellspacing="0" width="100%">
																			<tr>
																				<td valign="top" class="textContent">
																					...
																					-->
																					<h3 mc:edit="header" style="color:#5F5F5F;line-height:125%;font-family:Helvetica,Arial,sans-serif;font-size:20px;font-weight:normal;margin-top:0;margin-bottom:3px;text-align:left;">Client Info</h3>
																					...
																					<p style="width:100%">E-mail: '.$email.' </p>
																					<p style="width:100%">Please click on the e-mail address to respond. </p>
                                                                                    </div>
																				</td>
																			</tr>
																		</table>
